...
/**
 * Result message for commands.
 *
 * @param <R> the result type
 */
public class CommandResultMessage<R> implements ResultMessage<R> {
    ...
    public CommandResultMessage(String identifier, R payload, Throwable exception) {
