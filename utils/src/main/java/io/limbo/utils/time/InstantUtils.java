...
public class InstantUtils {
    ...
    public static String format(Instant instant, String pattern) {
        return format(instant, pattern, Formatters.DEFAULT_ZONE);
    }
    ...
    public static Instant parse(String instant, String pattern) {
        return parse(instant, pattern, Formatters.DEFAULT_ZONE);
    }
    ...
    public static Instant beginningOfDay(Instant instant) {
        return parse(formatYMD(instant) + " 00:00:00.000", Formatters.YMD_HMS_SSS);
    }
    ...
    public static Instant endingOfDay(Instant instant) {
        return parse(formatYMD(instant) + " 23:59:59.999", Formatters.YMD_HMS_SSS);
    }
    ...
    public static Instant beginningOfToday() {
        return beginningOfDay(Instant.now(Clock.system(Formatters.DEFAULT_ZONE)));
    }
    ...
    public static Instant endingOfToday() {
        return endingOfDay(Instant.now(Clock.system(Formatters.DEFAULT_ZONE)));
    }
